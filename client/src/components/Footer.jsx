    ...
    <footer className="bg-primary text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white text-xl font-bold">EcomShop</span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed">
              Your one-stop online store for premium fashion, accessories, and footwear. Delivering quality across Pakistan.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/shop?category=Shoes" className="hover:text-white transition">Shoes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="#" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-accent transition">
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-sm text-gray-500">&copy; 2026 EcomShop. All rights reserved.</p>
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <span>We accept:</span>
            <span className="bg-white/10 px-2 py-1 rounded text-xs font-medium text-green-400">JazzCash</span>
            <span className="bg-white/10 px-2 py-1 rounded text-xs font-medium">COD</span>
          </div>
        </div>
      </div>
    </footer>
